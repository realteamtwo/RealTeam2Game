...
void Backstory() {
	...
	cout << "Determined to escape, (Player)discovers that the tower is a labyrinth of shifting roomsand realms with enchanted traps, each one being a reflection of(Evil Alchemist) twisted mindand insatiable thirst for knowledge.\n";
